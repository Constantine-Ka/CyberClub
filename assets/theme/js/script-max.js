    ...
    a.fn.footerReveal = function () {
        function b() {
            !e && c.outerHeight() <= g.outerHeight()
                ...
                : (c.css({ "z-index": "", position: "", bottom: "" }), c.css({ width: "" }), d.css({ "margin-bottom": "" }));
        }
        var c = a(this),
            d = c.prev(),
            g = a(window),
                        ...
                        if (c && /youtu\.?be/g.test(c[3]))
                            (b = "http" + ("https:" === location.protocol ? "s" : "") + ":"),
                                ...
                                a("<img>")
                                    ...
                                    .attr("src", b),
                                !a.fn.YTPlayer || e || a.isMobile() || a("> *:eq(1)", this).before('<div class="mbr-background-video"></div>').prev().YTPlayer({ videoURL: c[6], containment: "self", showControls: !1, mute: !0 });
                        else {
            ...
            if (!a.isMobile() && a("input[name=animation]").length) {
                ...
                var d = a(
                        ...
                        .not(function () {
                            return a(this)
                                .parents()
                                .is("a, p, .navbar, .mbr-arrow, footer, .iconbox, .mbr-slider, .mbr-gallery, .mbr-testimonial .card-block, #cookiesdirective, .mbr-wowslider, .accordion, .tab-content, .engine, #scrollToTop");
                        })
                        .not(function () {
    ...
    a(document).ready(function () {
        if (!e) {
            ...
            a(".modalWindow-video iframe").each(function () {
                ...
                -1 !== b.indexOf("youtu")
                    ? a(this).attr("src", "https://youtube.com/embed/" + d[6] + "?rel=0&enablejsapi=1")
                ...
                a(this).closest(".card").find(".panel-collapse").hasClass("collapsing") ||
                    (-1 != b.indexOf("toggle")
                        ? a(this).hasClass("collapsed")
                            ? a(this).find("span.sign").removeClass("mbri-arrow-down").addClass("mbri-arrow-up")
...
!(function () {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.innerHTML = '<a href="https://mobirise.in">Mobirise Website Creator</a> Mobirise v5.3.0';
...
$('input[name="price"]').click(function(){
    console.log($(this).val());
     ...
     console.log("🚀 ~ file: price.html ~ line 391 ~ $ ~ target", target)
     
     $('.checkTar').not(target).hide(0);
     target.toggle();
 });